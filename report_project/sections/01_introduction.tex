...
\begin{figure}
    ...
    \subfigure[Stacked bar chart for flights to São Paulo]{
...
\begin{figure}
    ...
    \subfigure[Boxplot for flights to São Paulo]{
...
\begin{figure}
    \centering
    \subfigure[Flight price trend to New York]{
      \includegraphics[width=0.45\textwidth]{images/4_1_hour_price_air.png}
      \label{fig:left}
    }
    \subfigure[Flight price trend to São Paulo]{
      \includegraphics[width=0.45\textwidth]{images/4_2_hour_price_air.png}
      \label{fig:right}
    }
    \caption{Line plots showing the fluctuations in flight prices over time for Lufthansa and Swiss Airline to New York City and São Paulo.}
    \label{fig:line_pl}
\end{figure}
...
\begin{figure}
    ...
    \subfigure[Scatter plot for flights São Paulo]{
...
\begin{figure}
    ...
    \subfigure[Heatmap for flights for São Paulo]{
...
Despite these successes, several limitations were encountered in the project.
